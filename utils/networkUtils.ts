...
import {
    ...
    DeviceConfig,
    Route,
    DeviceTemplate,  // added import for DeviceTemplate
...
const findNetworkPath = (
    ...
    const queue: { deviceId: string; path: NetworkPathStep[] }[] = [];
