...
export default function CopyButton({ text }: CopyButtonProps) {
  ...
  return (
    <button
      ...
      className="absolute top-2 right-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 p-1.5 rounded-md transition-colors"
