// components/network-lab/Toolbar.tsx
...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 p-2 flex items-center justify-between">
