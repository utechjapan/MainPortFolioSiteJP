...
export default function TagPage({ posts, tag, recentPosts, tags }: TagPageProps) {
  return (
    <Layout recentPosts={recentPosts} tags={tags}>
      <Head>
        <title>Posts tagged "{tag}" | {siteConfig.title}</title>
...
export const getStaticProps: GetStaticProps<TagPageProps, Params> = async ({ params }) => {
